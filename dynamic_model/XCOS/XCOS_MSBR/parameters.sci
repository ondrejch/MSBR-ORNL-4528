...
mcp_t2   = 2.158E+00; // (mass of material x hmatlabeat capacity of material) of tube node 2 in MW-s/°C
...
mcp_tb   = m_t*cp_t; // (mass of material x heat capacity of material) of transfer lump in MW-s/°C
